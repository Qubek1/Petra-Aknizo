...
public class MouseCam : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        CxMin = Confiner.offset.x - Confiner.size.x/2;
        CxMax = Confiner.offset.x + Confiner.size.x/2;
        CyMin = Confiner.offset.y - Confiner.size.y/2;// Confiner.offset.y;
        CyMax = Confiner.offset.y + Confiner.size.y/2;
